<?php
	// Include the classfile for PackageTypeListPanelBase
	require(__PANELBASE_CLASSES__ . '/PackageTypeListPanelBase.class.php');
	 ...
	 * abstract PackageTypeListPanelBase class.
	 *
	 ...
	 * 
	 */
	class PackageTypeListPanel extends PackageTypeListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/PackageTypeListPanel.tpl.php';
