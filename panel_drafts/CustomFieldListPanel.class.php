<?php
	// Include the classfile for CustomFieldListPanelBase
	require(__PANELBASE_CLASSES__ . '/CustomFieldListPanelBase.class.php');
	 ...
	 * abstract CustomFieldListPanelBase class.
	 *
	 ...
	 * 
	 */
	class CustomFieldListPanel extends CustomFieldListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/CustomFieldListPanel.tpl.php';
