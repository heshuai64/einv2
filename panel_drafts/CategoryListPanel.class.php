<?php
	// Include the classfile for CategoryListPanelBase
	require(__PANELBASE_CLASSES__ . '/CategoryListPanelBase.class.php');
	 ...
	 * abstract CategoryListPanelBase class.
	 *
	 ...
	 * 
	 */
	class CategoryListPanel extends CategoryListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/CategoryListPanel.tpl.php';
