<?php
	// Include the classfile for TransactionListPanelBase
	require(__PANELBASE_CLASSES__ . '/TransactionListPanelBase.class.php');
	 ...
	 * abstract TransactionListPanelBase class.
	 *
	 ...
	 * 
	 */
	class TransactionListPanel extends TransactionListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/TransactionListPanel.tpl.php';
