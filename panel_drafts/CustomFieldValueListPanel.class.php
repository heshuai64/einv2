<?php
	// Include the classfile for CustomFieldValueListPanelBase
	require(__PANELBASE_CLASSES__ . '/CustomFieldValueListPanelBase.class.php');
	 ...
	 * abstract CustomFieldValueListPanelBase class.
	 *
	 ...
	 * 
	 */
	class CustomFieldValueListPanel extends CustomFieldValueListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/CustomFieldValueListPanel.tpl.php';
