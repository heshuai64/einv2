<?php
	// Include the classfile for DatagridColumnPreferenceListPanelBase
	require(__PANELBASE_CLASSES__ . '/DatagridColumnPreferenceListPanelBase.class.php');
	 ...
	 * abstract DatagridColumnPreferenceListPanelBase class.
	 *
	 ...
	 * 
	 */
	class DatagridColumnPreferenceListPanel extends DatagridColumnPreferenceListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/DatagridColumnPreferenceListPanel.tpl.php';
