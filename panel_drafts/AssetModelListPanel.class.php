<?php
	// Include the classfile for AssetModelListPanelBase
	require(__PANELBASE_CLASSES__ . '/AssetModelListPanelBase.class.php');
	 ...
	 * abstract AssetModelListPanelBase class.
	 *
	 ...
	 * 
	 */
	class AssetModelListPanel extends AssetModelListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/AssetModelListPanel.tpl.php';
