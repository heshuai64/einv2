<?php
	// Include the classfile for AddressListPanelBase
	require(__PANELBASE_CLASSES__ . '/AddressListPanelBase.class.php');
	 ...
	 * abstract AddressListPanelBase class.
	 *
	 ...
	 * 
	 */
	class AddressListPanel extends AddressListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/AddressListPanel.tpl.php';
