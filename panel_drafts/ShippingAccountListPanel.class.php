<?php
	// Include the classfile for ShippingAccountListPanelBase
	require(__PANELBASE_CLASSES__ . '/ShippingAccountListPanelBase.class.php');
	 ...
	 * abstract ShippingAccountListPanelBase class.
	 *
	 ...
	 * 
	 */
	class ShippingAccountListPanel extends ShippingAccountListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/ShippingAccountListPanel.tpl.php';
