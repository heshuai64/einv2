<?php
	// Include the classfile for CompanyListPanelBase
	require(__PANELBASE_CLASSES__ . '/CompanyListPanelBase.class.php');
	 ...
	 * abstract CompanyListPanelBase class.
	 *
	 ...
	 * 
	 */
	class CompanyListPanel extends CompanyListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/CompanyListPanel.tpl.php';
