<?php
	 ...
	 * must create a new Panel which extends this StateProvinceEditPanelBase
	 * class.
	 *
	 ...
	 * 
	 */
	abstract class StateProvinceEditPanelBase extends QPanel {
		...
		protected function SetupStateProvince($objStateProvince) {
			if ($objStateProvince) {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $objStateProvince = null, $strControlId = null) {
			...
			$this->SetupStateProvince($objStateProvince);
