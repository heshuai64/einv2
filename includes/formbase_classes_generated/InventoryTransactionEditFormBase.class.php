<?php
	 ...
	 * must create a new Form which extends this InventoryTransactionEditFormBase
	 * class.
	 *
	 ...
	 * 
	 */
	abstract class InventoryTransactionEditFormBase extends QForm {
		...
		protected function Form_Create() {
			...
			$this->SetupInventoryTransaction();
		...
		protected function RedirectToListPage() {
			QApplication::Redirect('inventory_transaction_list.php');
		}
	}
?>