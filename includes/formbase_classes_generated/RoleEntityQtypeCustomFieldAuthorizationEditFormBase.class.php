<?php
	 ...
	 * must create a new Form which extends this RoleEntityQtypeCustomFieldAuthorizationEditFormBase
	 * class.
	 *
	 ...
	 * 
	 */
	abstract class RoleEntityQtypeCustomFieldAuthorizationEditFormBase extends QForm {
		...
		protected function Form_Create() {
			...
			$this->SetupRoleEntityQtypeCustomFieldAuthorization();
		...
		protected function RedirectToListPage() {
			QApplication::Redirect('role_entity_qtype_custom_field_authorization_list.php');
		}
	}
?>