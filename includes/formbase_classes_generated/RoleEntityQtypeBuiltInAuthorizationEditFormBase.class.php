<?php
	 ...
	 * must create a new Form which extends this RoleEntityQtypeBuiltInAuthorizationEditFormBase
	 * class.
	 *
	 ...
	 * 
	 */
	abstract class RoleEntityQtypeBuiltInAuthorizationEditFormBase extends QForm {
		...
		protected function Form_Create() {
			...
			$this->SetupRoleEntityQtypeBuiltInAuthorization();
		...
		protected function RedirectToListPage() {
			QApplication::Redirect('role_entity_qtype_built_in_authorization_list.php');
		}
	}
?>