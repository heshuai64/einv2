<?php
	...
	$strPageTitle = $this->strTitleVerb . ' Notification';
	require(__INCLUDES__ . '/header.inc.php')
?>

	<?php $this->RenderBegin() ?>
		<div class="title_action"><?php _p($this->strTitleVerb); ?></div>
		<div class="title"><?php _t('Notification')?></div>
		<br class="item_divider" />

		<?php $this->lblNotificationId->RenderWithName(); ?>
		<br class="item_divider" />
		...
		<?php $this->txtCriteria->RenderWithName(); ?>
		<br class="item_divider" />

		<?php $this->txtFrequency->RenderWithName(); ?>
		<br class="item_divider" />

		<?php $this->chkEnabledFlag->RenderWithName(); ?>
		<br class="item_divider" />
