<?php
	...
	$strPageTitle = QApplication::Translate('List All') . ' Addresses';
	require(__INCLUDES__ . '/header.inc.php')
?>

	<?php $this->RenderBegin() ?>
		<div class="title_action"><?php _t('List All'); ?></div>
		<div class="title"><?php _t('Addresses'); ?></div>
		<br class="item_divider" />

		<?php $this->dtgAddress->Render() ?>
		<br />
		<a href="address_edit.php"><?php _t('Create a New'); ?> <?php _t('Address');?></a>
		 &nbsp;|&nbsp;
