<?php
	...
	$strPageTitle = $this->strTitleVerb . ' AdminSetting';
	require(__INCLUDES__ . '/header.inc.php')
?>

	<?php $this->RenderBegin() ?>
		<div class="title_action"><?php _p($this->strTitleVerb); ?></div>
		<div class="title"><?php _t('AdminSetting')?></div>
		<br class="item_divider" />

		<?php $this->lblSettingId->RenderWithName(); ?>
		<br class="item_divider" />

		<?php $this->txtShortDescription->RenderWithName(); ?>
		<br class="item_divider" />

		<?php $this->txtValue->RenderWithName("Rows=10"); ?>
		<br class="item_divider" />
