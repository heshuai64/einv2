<?php
	...
	$strPageTitle = $this->strTitleVerb . ' NotificationUserAccount';
	require(__INCLUDES__ . '/header.inc.php')
?>

	<?php $this->RenderBegin() ?>
		<div class="title_action"><?php _p($this->strTitleVerb); ?></div>
		<div class="title"><?php _t('NotificationUserAccount')?></div>
		<br class="item_divider" />

		<?php $this->lblNotificationUserAccountId->RenderWithName(); ?>
		<br class="item_divider" />

		<?php $this->lstUserAccount->RenderWithName(); ?>
		<br class="item_divider" />

		<?php $this->lstNotification->RenderWithName(); ?>
		<br class="item_divider" />
