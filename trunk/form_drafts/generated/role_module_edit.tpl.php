<?php
	...
	$strPageTitle = $this->strTitleVerb . ' RoleModule';
	require(__INCLUDES__ . '/header.inc.php')
?>

	<?php $this->RenderBegin() ?>
		<div class="title_action"><?php _p($this->strTitleVerb); ?></div>
		<div class="title"><?php _t('RoleModule')?></div>
		<br class="item_divider" />

		<?php $this->lblRoleModuleId->RenderWithName(); ?>
		<br class="item_divider" />
		...
		<?php $this->chkAccessFlag->RenderWithName(); ?>
		<br class="item_divider" />
