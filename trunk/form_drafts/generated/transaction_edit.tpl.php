<?php
	...
	$strPageTitle = $this->strTitleVerb . ' Transaction';
	require(__INCLUDES__ . '/header.inc.php')
?>

	<?php $this->RenderBegin() ?>
		<div class="title_action"><?php _p($this->strTitleVerb); ?></div>
		<div class="title"><?php _t('Transaction')?></div>
		<br class="item_divider" />

		<?php $this->lblTransactionId->RenderWithName(); ?>
		<br class="item_divider" />

		<?php $this->lstEntityQtype->RenderWithName(); ?>
		<br class="item_divider" />

		<?php $this->lstTransactionType->RenderWithName(); ?>
		<br class="item_divider" />

		<?php $this->txtNote->RenderWithName("Rows=10"); ?>
		<br class="item_divider" />
		...
		<?php $this->lstReceipt->RenderWithName(); ?>
		<br class="item_divider" />
