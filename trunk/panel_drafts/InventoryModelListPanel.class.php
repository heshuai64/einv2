<?php
	// Include the classfile for InventoryModelListPanelBase
	require(__PANELBASE_CLASSES__ . '/InventoryModelListPanelBase.class.php');
	 ...
	 * abstract InventoryModelListPanelBase class.
	 *
	 ...
	 * 
	 */
	class InventoryModelListPanel extends InventoryModelListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/InventoryModelListPanel.tpl.php';
