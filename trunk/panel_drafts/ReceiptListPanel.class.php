<?php
	// Include the classfile for ReceiptListPanelBase
	require(__PANELBASE_CLASSES__ . '/ReceiptListPanelBase.class.php');
	 ...
	 * abstract ReceiptListPanelBase class.
	 *
	 ...
	 * 
	 */
	class ReceiptListPanel extends ReceiptListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/ReceiptListPanel.tpl.php';
