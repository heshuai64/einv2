<?php
	// Include the classfile for NotificationListPanelBase
	require(__PANELBASE_CLASSES__ . '/NotificationListPanelBase.class.php');
	 ...
	 * abstract NotificationListPanelBase class.
	 *
	 ...
	 * 
	 */
	class NotificationListPanel extends NotificationListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/NotificationListPanel.tpl.php';
