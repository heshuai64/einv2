<?php
	// Include the classfile for CustomFieldSelectionListPanelBase
	require(__PANELBASE_CLASSES__ . '/CustomFieldSelectionListPanelBase.class.php');
	 ...
	 * abstract CustomFieldSelectionListPanelBase class.
	 *
	 ...
	 * 
	 */
	class CustomFieldSelectionListPanel extends CustomFieldSelectionListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/CustomFieldSelectionListPanel.tpl.php';
