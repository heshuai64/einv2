<?php
	 ...
	 * abstract AddressEditPanelBase class.
	 *
	...
	class AddressEditPanel extends AddressEditPanelBase {
		...
		protected $strTemplate = 'generated/AddressEditPanel.tpl.php';

/*
		public function __construct($objParentObject, $strClosePanelMethod, $objAddress = null, $strControlId = null) {
			try {
				parent::__construct($objParentObject, $strClosePanelMethod, $objAddress, $strControlId);
