<?php
	// Include the classfile for LengthUnitListPanelBase
	require(__PANELBASE_CLASSES__ . '/LengthUnitListPanelBase.class.php');
	 ...
	 * abstract LengthUnitListPanelBase class.
	 *
	 ...
	 * 
	 */
	class LengthUnitListPanel extends LengthUnitListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/LengthUnitListPanel.tpl.php';
