<?php
	// Include the classfile for DatagridListPanelBase
	require(__PANELBASE_CLASSES__ . '/DatagridListPanelBase.class.php');
	 ...
	 * abstract DatagridListPanelBase class.
	 *
	 ...
	 * 
	 */
	class DatagridListPanel extends DatagridListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/DatagridListPanel.tpl.php';
