<?php
	// Include the classfile for EntityQtypeCustomFieldListPanelBase
	require(__PANELBASE_CLASSES__ . '/EntityQtypeCustomFieldListPanelBase.class.php');
	 ...
	 * abstract EntityQtypeCustomFieldListPanelBase class.
	 *
	 ...
	 * 
	 */
	class EntityQtypeCustomFieldListPanel extends EntityQtypeCustomFieldListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/EntityQtypeCustomFieldListPanel.tpl.php';
