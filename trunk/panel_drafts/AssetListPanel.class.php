<?php
	// Include the classfile for AssetListPanelBase
	require(__PANELBASE_CLASSES__ . '/AssetListPanelBase.class.php');
	 ...
	 * abstract AssetListPanelBase class.
	 *
	 ...
	 * 
	 */
	class AssetListPanel extends AssetListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/AssetListPanel.tpl.php';
