<?php
	// Include the classfile for RoleModuleAuthorizationListPanelBase
	require(__PANELBASE_CLASSES__ . '/RoleModuleAuthorizationListPanelBase.class.php');
	 ...
	 * abstract RoleModuleAuthorizationListPanelBase class.
	 *
	 ...
	 * 
	 */
	class RoleModuleAuthorizationListPanel extends RoleModuleAuthorizationListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/RoleModuleAuthorizationListPanel.tpl.php';
