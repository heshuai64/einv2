<?php
	// Include the classfile for CourierListPanelBase
	require(__PANELBASE_CLASSES__ . '/CourierListPanelBase.class.php');
	 ...
	 * abstract CourierListPanelBase class.
	 *
	 ...
	 * 
	 */
	class CourierListPanel extends CourierListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/CourierListPanel.tpl.php';
