<?php
	// Include the classfile for RoleModuleListPanelBase
	require(__PANELBASE_CLASSES__ . '/RoleModuleListPanelBase.class.php');
	 ...
	 * abstract RoleModuleListPanelBase class.
	 *
	 ...
	 * 
	 */
	class RoleModuleListPanel extends RoleModuleListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/RoleModuleListPanel.tpl.php';
