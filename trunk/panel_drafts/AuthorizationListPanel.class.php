<?php
	// Include the classfile for AuthorizationListPanelBase
	require(__PANELBASE_CLASSES__ . '/AuthorizationListPanelBase.class.php');
	 ...
	 * abstract AuthorizationListPanelBase class.
	 *
	 ...
	 * 
	 */
	class AuthorizationListPanel extends AuthorizationListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/AuthorizationListPanel.tpl.php';
