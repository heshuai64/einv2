<?php
	// Include the classfile for StateProvinceListPanelBase
	require(__PANELBASE_CLASSES__ . '/StateProvinceListPanelBase.class.php');
	 ...
	 * abstract StateProvinceListPanelBase class.
	 *
	 ...
	 * 
	 */
	class StateProvinceListPanel extends StateProvinceListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/StateProvinceListPanel.tpl.php';
