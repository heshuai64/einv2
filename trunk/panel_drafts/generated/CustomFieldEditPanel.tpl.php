...
?>
		<?php $_CONTROL->lblCustomFieldId->RenderWithName(); ?>
		<br class="item_divider" />

		<?php $_CONTROL->lstCustomFieldQtype->RenderWithName(); ?>
		<br class="item_divider" />

		<?php $_CONTROL->lstDefaultCustomFieldValue->RenderWithName(); ?>
		<br class="item_divider" />
		...
		<?php $_CONTROL->chkRequiredFlag->RenderWithName(); ?>
		<br class="item_divider" />
