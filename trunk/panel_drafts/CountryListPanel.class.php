<?php
	// Include the classfile for CountryListPanelBase
	require(__PANELBASE_CLASSES__ . '/CountryListPanelBase.class.php');
	 ...
	 * abstract CountryListPanelBase class.
	 *
	 ...
	 * 
	 */
	class CountryListPanel extends CountryListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/CountryListPanel.tpl.php';
