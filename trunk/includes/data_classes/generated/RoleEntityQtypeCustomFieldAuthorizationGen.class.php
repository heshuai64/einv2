<?php
	...
	class RoleEntityQtypeCustomFieldAuthorizationGen extends QBaseClass {
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objQueryBuilder->AddFromItem('`role_entity_qtype_custom_field_authorization` AS `role_entity_qtype_custom_field_authorization`');
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			return RoleEntityQtypeCustomFieldAuthorization::InstantiateDbRow($objDbResult->GetNextRow());
		}
		...
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return RoleEntityQtypeCustomFieldAuthorization::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNodes);
		}
...
/*		public static function QueryArrayCached($strConditions, $mixParameterArray = null) {
		...
		public static function GetSelectFields(QQueryBuilder $objBuilder, $strPrefix = null) {
			...
			$objBuilder->AddSelectItem($strTableName . '.`role_entity_qtype_custom_field_authorization_id` AS ' . $strAliasPrefix . 'role_entity_qtype_custom_field_authorization_id`');
		...
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $strExpandAsArrayNodes = null, $objPreviousItem = null) {
			...
			$objToReturn->intRoleEntityQtypeCustomFieldAuthorizationId = $objDbRow->GetColumn($strAliasPrefix . 'role_entity_qtype_custom_field_authorization_id', 'Integer');
			...
			if (!is_null($objDbRow->GetColumn($strAliasPrefix . 'entity_qtype_custom_field_id__entity_qtype_custom_field_id')))
				$objToReturn->objEntityQtypeCustomField = EntityQtypeCustomField::InstantiateDbRow($objDbRow, $strAliasPrefix . 'entity_qtype_custom_field_id__', $strExpandAsArrayNodes);
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $strExpandAsArrayNodes = null) {
			...
			if ($strExpandAsArrayNodes) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = RoleEntityQtypeCustomFieldAuthorization::InstantiateDbRow($objDbRow, null, $strExpandAsArrayNodes, $objLastRowItem);
					if ($objItem) {
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					array_push($objToReturn, RoleEntityQtypeCustomFieldAuthorization::InstantiateDbRow($objDbRow));
			}
				...
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					if (!$blnForceUpdate) {
						...
						if ($objRow[0] != $this->strModifiedDate)
							throw new QExtendedOptimisticLockingException('RoleEntityQtypeCustomFieldAuthorization', $this->intRoleEntityQtypeCustomFieldAuthorizationId);
					}
	...
	class QQNodeRoleEntityQtypeCustomFieldAuthorization extends QQNode {
		...
		public function __get($strName) {
			switch ($strName) {
				case 'RoleEntityQtypeCustomFieldAuthorizationId':
					return new QQNode('role_entity_qtype_custom_field_authorization_id', 'integer', $this);
				case 'RoleId':
				...
				case 'EntityQtypeCustomField':
					return new QQNodeEntityQtypeCustomField('entity_qtype_custom_field_id', 'integer', $this);
				case 'AuthorizationId':
