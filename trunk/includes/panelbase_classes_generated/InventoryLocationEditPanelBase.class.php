<?php
	 ...
	 * must create a new Panel which extends this InventoryLocationEditPanelBase
	 * class.
	 *
	 ...
	 * 
	 */
	abstract class InventoryLocationEditPanelBase extends QPanel {
		...
		public $lblInventoryLocationId;
		public $lstInventoryModel;
		public $lstLocation;
		public $txtQuantity;
		...
		protected function SetupInventoryLocation($objInventoryLocation) {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $objInventoryLocation = null, $strControlId = null) {
			...
			$this->SetupInventoryLocation($objInventoryLocation);
