<?php
	 ...
	 * must create a new QPanel which extends this FedexShipmentListPanelBase
	 * class.
	 *
	 ...
	 * 
	 */
	abstract class FedexShipmentListPanelBase extends QPanel {
		public $dtgFedexShipment;
		public $btnCreateNew;
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			$this->colEditLinkColumn = new QDataGridColumn(QApplication::Translate('Edit'), '<?= $_CONTROL->ParentControl->dtgFedexShipment_EditLinkColumn_Render($_ITEM) ?>');
			...
			$this->colShipmentId = new QDataGridColumn(QApplication::Translate('Shipment Id'), '<?= $_CONTROL->ParentControl->dtgFedexShipment_Shipment_Render($_ITEM); ?>');
			$this->colPackageTypeId = new QDataGridColumn(QApplication::Translate('Package Type Id'), '<?= $_CONTROL->ParentControl->dtgFedexShipment_PackageType_Render($_ITEM); ?>');
			$this->colShippingAccountId = new QDataGridColumn(QApplication::Translate('Shipping Account Id'), '<?= $_CONTROL->ParentControl->dtgFedexShipment_ShippingAccount_Render($_ITEM); ?>');
			$this->colFedexServiceTypeId = new QDataGridColumn(QApplication::Translate('Fedex Service Type Id'), '<?= $_CONTROL->ParentControl->dtgFedexShipment_FedexServiceType_Render($_ITEM); ?>');
			$this->colCurrencyUnitId = new QDataGridColumn(QApplication::Translate('Currency Unit Id'), '<?= $_CONTROL->ParentControl->dtgFedexShipment_CurrencyUnit_Render($_ITEM); ?>');
			$this->colWeightUnitId = new QDataGridColumn(QApplication::Translate('Weight Unit Id'), '<?= $_CONTROL->ParentControl->dtgFedexShipment_WeightUnit_Render($_ITEM); ?>');
			$this->colLengthUnitId = new QDataGridColumn(QApplication::Translate('Length Unit Id'), '<?= $_CONTROL->ParentControl->dtgFedexShipment_LengthUnit_Render($_ITEM); ?>');
			...
			$this->colHoldAtLocationState = new QDataGridColumn(QApplication::Translate('Hold At Location State'), '<?= $_CONTROL->ParentControl->dtgFedexShipment_HoldAtLocationStateObject_Render($_ITEM); ?>');
			...
			$this->dtgFedexShipment->UseAjax = true;

			// Specify the local databind method this datagrid will use
			$this->dtgFedexShipment->SetDataBinder('dtgFedexShipment_Bind', $this);
			...
			$this->btnCreateNew->Text = QApplication::Translate('Create a New') . ' ' . QApplication::Translate('FedexShipment');
			$this->btnCreateNew->AddAction(new QClickEvent(), new QAjaxControlAction($this, 'btnCreateNew_Click'));
		}

		public function dtgFedexShipment_EditLinkColumn_Render(FedexShipment $objFedexShipment) {
			$strControlId = 'btnEdit' . $this->dtgFedexShipment->CurrentRowIndex;

			$btnEdit = $this->objForm->GetControl($strControlId);
			if (!$btnEdit) {
				$btnEdit = new QButton($this->dtgFedexShipment, $strControlId);
				$btnEdit->Text = QApplication::Translate('Edit');
				$btnEdit->AddAction(new QClickEvent(), new QAjaxControlAction($this, 'btnEdit_Click'));
			}

			$btnEdit->ActionParameter = $objFedexShipment->FedexShipmentId;
		...
		public function btnCreateNew_Click($strFormId, $strControlId, $strParameter) {
			$objEditPanel = new FedexShipmentEditPanel($this, $this->strCloseEditPanelMethod, null);
			$strMethodName = $this->strSetEditPanelMethod;
			$this->objForm->$strMethodName($objEditPanel);
		}
